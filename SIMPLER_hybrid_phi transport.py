...
def main():
    ...
    plt.colorbar(cp)
    plt.title('Pressure field u={:.2f} mu={:.3f}_SIMPLER/Hybrid'.format(u_inlet, mu))
    plt.xlabel('X')
    plt.ylabel('Y')
    plt.show()
    ...
    plt.title('Velocity Magnitude u={:.2f} mu={:.3f}_SIMPLER/Hybrid'.format(u_inlet, mu))
    plt.xlabel('X')
    plt.ylabel('Y')
    plt.show()
    ...
    plt.title('Velocity Vector Field u={:.2f} mu={:.3f}_SIMPLER/Hybrid'.format(u_inlet, mu))
    plt.xlabel('X')
    plt.ylabel('Y')
    plt.show()
    ...
    plt.colorbar(cp)
    plt.title('pi field u={:.2f} mu={:.3f} Gamma={:.3f}_SIMPLER/Hybrid'.format(u_inlet, mu, Gamma))
    plt.xlabel('X')
    plt.ylabel('Y')
    plt.show()
